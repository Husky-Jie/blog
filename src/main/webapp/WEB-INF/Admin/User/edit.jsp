...
<rapid:override name="content">
    ...
    <form class="layui-form" action="/admin/user/editSubmit" id="userForm"
          method="post">
        <input type="hidden" name="userId" id="userId" value="${user01.userId}">
        <div class="layui-form-item">
            <label class="layui-form-label">头像</label>
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="${user01.userAvatar}" id="demo1" width="100"
                             height="100">
                        <p id="demoText"></p>
                    </div>
                    <button type="button" class="layui-btn" id="test1">上传图片</button>
                    <input type="hidden" name="userAvatar" id="userAvatar" value="${user01.userAvatar}">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${user01.userName}" name="userName" id="userName" required
                       lay-verify="userName"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="userPass" value="${user01.userPass}" id="userPass" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="userNickname" value="${user01.userNickname}" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="email" name="userEmail" value="${user01.userEmail}" id="userEmail" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="url" name="userUrl" value="${user01.userUrl}" placeholder="" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="userStatus" value="1" title="正常" <c:if test="${user01.userStatus==1}">checked</c:if>>
                <input type="radio" name="userStatus" value="0" title="禁用" <c:if test="${user01.userStatus==0}">checked</c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
